...
nodeKeys = {'258 - French Polynesia'; '470 - Malta'; '620 - Portugal'; '120 - Camerron'; '348 - Hungary'; '4 - Afghanistan'; '372 - Ireland'; '296 - Kirbati'; '70 - Bonsia and Herzegovina'; '162 - Christmas Islands'};
disp(nodeKeys); % Displays a Key for the each node's corresponding country code and name (in order of selection, for example Node 7 = '372 - Ireland')
